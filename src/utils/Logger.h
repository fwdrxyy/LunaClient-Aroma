...
#define LOG_APP_NAME "LunaClient"
...
#define LOG_EX(FILENAME, FUNCTION, LINE, LOG_FUNC, LOG_LEVEL, LINE_END, FMT, ARGS...)                                                                                    \
    do { LOG_FUNC("[(%s)%18s][%23s]%30s@L%04d: " LOG_LEVEL "" FMT "" LINE_END, LOG_APP_TYPE, LOG_APP_NAME, FILENAME, FUNCTION, LINE, ##ARGS); } while (0)
...
#define DEBUG_OSFATAL(str)                                                     OSFatal(str)
...
#define DEBUG_OSFATAL(str)                                                     while (0)
