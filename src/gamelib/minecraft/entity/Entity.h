...
namespace mc {
    ...
    public:
        Entity() = default;
        Entity(Level *level, bool unk1);

        void setupForSpawn(const mstd::wstring &name);
        ...
        DEFINE_STATIC_VAR(VTable *, boost_detail, 0x105CC9B4);
